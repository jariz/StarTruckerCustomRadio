...
namespace StarTruckerCustomRadio
{
    public class TrackInfo
    {
        ...
        //private StreamedAudioClip streamedAudioClip;
    ...
    public class Core : MelonMod
    {
        ...
        public Il2CppSystem.Collections.Generic.List<SongDescription> GetSongDescriptions()
        {
            ...
            foreach (var (item, index) in trackInfos.WithIndex())
            {
                ...
                StringTable.stringTable.Add(song.artistNameStringId, item.Tag.Title);
                StringTable.stringTable.Add(song.songNameStringId, item.Tag.JoinedPerformers);
